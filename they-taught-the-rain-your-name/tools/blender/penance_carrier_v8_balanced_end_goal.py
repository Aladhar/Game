"""
Penance Carrier V8 balanced end-goal pass.
...
Outputs:
  assets/models/enemies/penance_carrier/blender_work/penance_carrier_end_goal_v8_balanced_end_goal.blend
  assets/models/enemies/penance_carrier/penance_carrier_end_goal_v8_balanced_end_goal.glb
"""
...
OUTPUT_BLEND = WORK_DIR / "penance_carrier_end_goal_v8_balanced_end_goal.blend"
OUTPUT_GLB = ASSET_ROOT / "penance_carrier_end_goal_v8_balanced_end_goal.glb"
...
def main() -> None:
    print("Penance Carrier V8 balanced end-goal pass starting...", flush=True)
    random.seed(1808)
    clear_scene()
    create_materials()
