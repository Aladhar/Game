"""
Penance Carrier V5 detail-density pass.

This pass builds on the V4 silhouette-lock proportions and adds:
...
Outputs:
  assets/models/enemies/penance_carrier/blender_work/penance_carrier_end_goal_v5_detail_density.blend
  assets/models/enemies/penance_carrier/penance_carrier_end_goal_v5_detail_density.glb
"""
...
OUTPUT_BLEND = WORK_DIR / "penance_carrier_end_goal_v5_detail_density.blend"
OUTPUT_GLB = ASSET_ROOT / "penance_carrier_end_goal_v5_detail_density.glb"
    ...
    for side, sign in [("left", -1), ("right", 1)]:
        for i, z in enumerate([0.38, 0.50, 0.62, 0.78, 0.94, 1.10]):
            box(
                ...
                (0.24, 0.035, 0.034),
                MAT["raw_wood"] if i % 4 == 0 else MAT["cloth"],
...
def add_v5_shrine_density() -> None:
    ...
    for i, (x, z) in enumerate([(-0.68, 2.18), (-0.48, 2.28), (0.48, 2.24), (0.68, 2.18), (0.0, 3.20)]):
...
def main() -> None:
    print("Penance Carrier V5 detail-density pass starting...", flush=True)
    random.seed(1505)
    clear_scene()
    create_materials()
