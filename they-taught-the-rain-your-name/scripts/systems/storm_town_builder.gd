...
func add_box(name: String, pos: Vector3, size: Vector3, material, collision_enabled: bool) -> MeshInstance3D:
...
func build_entrance_sign(pos: Vector3) -> void:
    ...
    var sign = add_box("GreyhollowSign", pos + Vector3(0, 1.8, 0), Vector3(5.0, 1.0, 0.12), mat_wood, true)
